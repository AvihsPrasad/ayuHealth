...
import { CameraIcon, InboxIcon, PencilSquareIcon, PhotoIcon, XCircleIcon } from '@heroicons/react/24/outline'
      ...
      {activeTab === 'Account' && (
        ...
        <div className='grow flex flex-row gap-6'>
          <div className='relative w-24 h-24 bg-stone-300 items-center justify-center rounded-full flex'>
            ...
            <img alt="" id='profileImg' src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" 
